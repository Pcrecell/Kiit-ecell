  ...
  return (
      ...
      <div className="mt-4 flex flex-row gap-4 px-4 sm:px-6 items-center ml-4 ">
        <button
          ...
          className="bg-neutral-700 hover:bg-[#FE5A1F] text-white px-6 py-2 rounded-full font-[syne] text-sm sm:text-base transition-colors"
        >
          STUDENTS
        </button>
        <button
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 my-16 px-4 items-start">
      ...
      <div className="flex justify-center items-center">
       <img
          src="https://ik.imagekit.io/d73k0qzwc/Group%209.png"
          alt="ICAMP"
      ...
      <div className="flex flex-col items-center gap-4 w-full">
        ...
        <button onClick={() => navigate("/maverick")} className="bg-[#FE5A1F] hover:bg-[#FE5A1F] text-white px-6 sm:px-8 py-3 sm:py-3 rounded-full font-semibold text-sm sm:text-base transition-colors">
          CHECK OUR WEBSITE
        </button>
      </div>
    </div>
